...
import com.example.baker_street.databinding.ActivityPdfViewBinding
...
class Activity_pdfView : AppCompatActivity() {
...
//    var pdfUrl = "https://unec.edu.az/application/uploads/2014/12/pdf-sample.pdf"
    var pdfUrl = "https://storage.googleapis.com/bakerstreet-dd266.appspot.com/file_1680923187311.pdf"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.pdfRead
        RetrievePDFFromURL(binding.pdfRead).execute(pdfUrl)
    }
